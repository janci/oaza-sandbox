...
namespace OazaCMS\Extensions\Core\Widgets\Copyright;
 ...
 * @author  Jan Svantner
 */
class Copyright extends \Oaza\Application\UI\Widget implements IBuildControl
{
    ...
    public function startup(){
        ...
        $this->addProperty(new Property(PropertyType::STRING, "align", "center"));
        $this->addProperty(new Property(PropertyType::STRING, "company", 'Company s.r.o'));
        $this->addProperty(new Property(PropertyType::STRING, "separator", '-'));
        $this->addProperty(new Property(PropertyType::STRING, "created", date('Y')));
